...
public class JanelaPrincipald extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JanelaPrincipald frame = new JanelaPrincipald();
	 ...
	 * Create the frame.
	 */
	public JanelaPrincipald() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 558, 498);
		...
		panel_1.setBounds(38, 102, 445, 326);
